...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenWeatherMapApi.Clouds();
  });
  ...
  describe('Clouds', function() {
    it('should create an instance of Clouds', function() {
      // uncomment below and update the code to test Clouds
      //var instance = new OpenWeatherMapApi.Clouds();
      //expect(instance).to.be.a(OpenWeatherMapApi.Clouds);
    });
