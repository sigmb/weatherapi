...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenWeatherMapApi.Coord();
  });
  ...
  describe('Coord', function() {
    it('should create an instance of Coord', function() {
      // uncomment below and update the code to test Coord
      //var instance = new OpenWeatherMapApi.Coord();
      //expect(instance).to.be.a(OpenWeatherMapApi.Coord);
    });
