...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenWeatherMapApi.Rain();
  });
  ...
  describe('Rain', function() {
    it('should create an instance of Rain', function() {
      // uncomment below and update the code to test Rain
      //var instance = new OpenWeatherMapApi.Rain();
      //expect(instance).to.be.a(OpenWeatherMapApi.Rain);
    });
