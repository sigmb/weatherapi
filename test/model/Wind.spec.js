...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenWeatherMapApi.Wind();
  });
  ...
  describe('Wind', function() {
    it('should create an instance of Wind', function() {
      // uncomment below and update the code to test Wind
      //var instance = new OpenWeatherMapApi.Wind();
      //expect(instance).to.be.a(OpenWeatherMapApi.Wind);
    });

    it('should have the property deg (base name: "deg")', function() {
      // uncomment below and update the code to test the property deg
      //var instance = new OpenWeatherMapApi.Wind();
