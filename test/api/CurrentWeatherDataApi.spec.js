...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenWeatherMapApi.CurrentWeatherDataApi();
  });
  ...
  describe('CurrentWeatherDataApi', function() {
    describe('currentWeatherData', function() {
      it('should call currentWeatherData successfully', function(done) {
        //uncomment below and update the code to test currentWeatherData
        //instance.currentWeatherData(function(error) {
