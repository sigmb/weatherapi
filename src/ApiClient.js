...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OpenWeatherMapApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     */
    this.basePath = 'https://api.openweathermap.org/data/2.5/'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'app_id': {type: 'apiKey', 'in': 'query', name: 'appid'}
    };
    /**
