...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OpenWeatherMapApi.Coord = factory(root.OpenWeatherMapApi.ApiClient);
  }
  ...
  /**
   * Constructs a <code>Coord</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Coord} obj Optional instance to populate.
   * @return {module:model/Coord} The populated <code>Coord</code> instance.
   */
